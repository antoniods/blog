...
function createParserPlugins() {
  ...
  function kgHtmlCardToCard(node, builder, _ref) {
    let {
      addSection,
      nodeFinished
    } = _ref;
  ...
  function kgCalloutCardToCard(node, builder, _ref2) {
    let {
      addSection,
      nodeFinished
    } = _ref2;
  ...
  function kgToggleCardToCard(node, builder, _ref3) {
    let {
      addSection,
      nodeFinished
    } = _ref3;
  ...
  function brToSoftBreakAtom(node, builder, _ref4) {
    let {
      addMarkerable,
      nodeFinished
    } = _ref4;
  ...
  const kgGalleryCardToCard = (node, builder, _ref5) => {
    let {
      addSection,
      nodeFinished
    } = _ref5;
  ...
  function grafGalleryToCard(node, builder, _ref6) {
    let {
      addSection,
      nodeFinished
    } = _ref6;
  ...
  function sqsGalleriesToCard(node, builder, _ref7) {
    let {
      addSection,
      nodeFinished
    } = _ref7;
  ...
  function figureToImageCard(node, builder, _ref8) {
    let {
      addSection,
      nodeFinished
    } = _ref8;
  ...
  function imgToCard(node, builder, _ref9) {
    let {
      addSection,
      nodeFinished
    } = _ref9;
  ...
  function hrToCard(node, builder, _ref10) {
    let {
      addSection,
      nodeFinished
    } = _ref10;
  ...
  function figureToCodeCard(node, builder, _ref11) {
    let {
      addSection,
      nodeFinished
    } = _ref11;
  ...
  function preCodeToCard(node, builder, _ref12) {
    let {
      addSection,
      nodeFinished
    } = _ref12;
  ...
  function figureScriptToHtmlCard(node, builder, _ref13) {
    let {
      addSection,
      nodeFinished
    } = _ref13;
  ...
  function tableToHtmlCard(node, builder, _ref14) {
    let {
      addSection,
      nodeFinished
    } = _ref14;
  ...
  return [fromMixtape(options), kgHtmlCardToCard, fromKoenigCard(), fromWordpressButton(), fromSubstackButton(), kgCalloutCardToCard, kgToggleCardToCard, blockquoteWithChildren, brToSoftBreakAtom, removeLeadingNewline, kgGalleryCardToCard, fromFigureBlockquote(options), // I think these can contain images
